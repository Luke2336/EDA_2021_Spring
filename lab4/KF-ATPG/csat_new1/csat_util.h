...
kf_hash(int size = 503, int density = 5, double grow_factor = 2.0,
	int reorder_flag = 0)
    {
    _num_entries = 0;
...
// clear the kf_hash table
template<class KEY, class VALUE, class HASH_FUNC>
void 
kf_hash<KEY, VALUE, HASH_FUNC>::clear()
{
...
template<class KEY, class VALUE, class HASH_FUNC>
bool 
kf_hash<KEY, VALUE, HASH_FUNC>::lookup(KEY key, VALUE& value)
{
int hash_val;
HASH_FUNC hf;
...
template<class KEY, class VALUE, class HASH_FUNC>
bool 
kf_hash<KEY, VALUE, HASH_FUNC>::insert(KEY key, VALUE value)
{
int hash_val;
HASH_FUNC hf;
...
template<class KEY, class VALUE, class HASH_FUNC>
bool 
kf_hash<KEY, VALUE, HASH_FUNC>::rehash()
{
int hash_val;
HASH_FUNC hf;
...
template<class KEY, class VALUE, class HASH_FUNC>
bool 
kf_hash<KEY, VALUE, HASH_FUNC>::remove(KEY key)
{
int hash_val;
HASH_FUNC hf;
...
template<class KEY, class VALUE, class HASH_FUNC>
VALUE& 
kf_hash<KEY, VALUE, HASH_FUNC>::operator[](KEY key)
{
int hash_val;
HASH_FUNC hf;
VALUE value(0);
