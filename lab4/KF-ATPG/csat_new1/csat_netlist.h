...
kf_hash<string, SGate*, S_strhash> _name_table;
kf_hash<void*, void*, S_ptrhash<void*> > _fl_table;
kf_hash<void*, SGate*, S_ptrhash<void*> > _fl_inv_table;
kf_hash<void*, void*, S_ptrhash<void*> > _sec_table;
vector<void*> _vmap;

kf_hash<SGate*, vector<string>*, S_ptrhash<SGate*> > _fanin_table;
