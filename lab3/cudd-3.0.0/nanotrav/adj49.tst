...
Maximum resident size            = 5058560K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1368
Swaps = 0
Input blocks = 0
Output blocks = 1
Context switch (voluntary) = 0
Context switch (involuntary) = 66
